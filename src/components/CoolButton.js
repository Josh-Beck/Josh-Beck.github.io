...
export default function CoolButton(props) {
    ...
    return (
        <div className="pl-7 pt-3 text-lg">
            <a href={props.href} className="z-50 relative inline-flex items-center justify-start py-3 pr-12 overflow-hidden font-semibold secondary-color-text transition-all duration-150 ease-in-out rounded-xl hover:pl-9 hover:pr-3 bg-opacity-0 group">
