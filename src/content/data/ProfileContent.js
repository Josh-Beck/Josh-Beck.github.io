...
export const PROFILE_TITLE = "Biography";
...
export default function ProfileContent() {
    return (
        <div>
            ...
            <br />
            <br />
            My expertise is rooted in application security, with a strong background in cloud and API security gained from my time
            at John Deere. During my tenure there, I developed and implemented key security controls for cloud-based applications, 
            led security reviews of critical APIs, and reduced security vulnerabilities by 50%. 
            <br />
            <br />
            ...
            abilities, and offensive testing skills.<br />
            <ul>
                <li>CompTIA Security+ (2023)</li>
                <li>AWS Developer Associate (2021-2024)</li>
                <li>AWS Security Specialty (2021-2024)</li>
                <li>Offensive Security Web Assessor (2023)</li>
            </ul>
            <br />
